...
CHECKPOINT_NAME = '../utils/train/crack/model/tmp/_retrain_checkpoint'
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--output_graph',
      type=str,
      default='../utils/train/crack/model/tmp/output_graph.pb',
      help='Where to save the trained graph.'
  )
  parser.add_argument(
      '--intermediate_output_graphs_dir',
      type=str,
      default='../utils/train/crack/model/tmp/intermediate_graph/',
  ...
  parser.add_argument(
      '--output_labels',
      type=str,
      default='../utils/train/crack/model/tmp/output_labels.txt',
      help='Where to save the trained graph\'s labels.'
  )
  parser.add_argument(
      '--summaries_dir',
      type=str,
      default='../utils/train/crack/model/tmp/retrain_logs',
  ...
  parser.add_argument(
      '--bottleneck_dir',
      type=str,
      default='../utils/train/crack/model/tmp/bottleneck',
